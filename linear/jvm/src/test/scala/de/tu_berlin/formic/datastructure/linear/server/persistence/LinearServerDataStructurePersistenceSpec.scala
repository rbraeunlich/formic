package de.tu_berlin.formic.datastructure.linear.server.persistence
...
import de.tu_berlin.formic.datastructure.linear.server.{IntegerListDataStructureFactory, LinearServerDataStructure}
import de.tu_berlin.formic.datastructure.linear.server.IntegerListDataStructureFactory
