...
/**
  ...
  */
class JsonServerDataType(id: DataTypeInstanceId, controlAlgorithm: ControlAlgorithm, val dataTypeName: DataTypeName) extends AbstractServerDataType(id, controlAlgorithm) {
...
object JsonServerDataType {
  def apply[T](id: DataTypeInstanceId, controlAlgorithm: ControlAlgorithm, dataTypeName: DataTypeName): JsonServerDataType = new JsonServerDataType(id, controlAlgorithm, dataTypeName)
}